 ...
 */var kg;function Vx(){if(kg)return yo;kg=1;var o=Symbol.for("react.transitional.element"),e=Symbol.for("react.fragment");function i(r,l,u){var h=null;if(u!==void 0&&(h=""+u),l.key!==void 0&&(h=""+l.key),"key"in l){u={};for(var d in l)d!=="key"&&(u[d]=l[d])}else u=l;return l=u.ref,{$$typeof:o,type:r,key:h,ref:l!==void 0?l:null,props:u}}return yo.Fragment=e,yo.jsx=i,yo.jsxs=i,yo}var Xg;function kx(){return Xg||(Xg=1,Lf.exports=Vx()),Lf.exports}var It=kx(),Nf={exports:{}},Eo={},Of={exports:{}},Pf={};/**
 * @license React
...
#define LOW_PRECISION`),e}function Ab(o){let e="SHADOWMAP_TYPE_BASIC";return o.shadowMapType===n0?e="SHADOWMAP_TYPE_PCF":o.shadowMapType===tS?e="SHADOWMAP_TYPE_PCF_SOFT":o.shadowMapType===Qi&&(e="SHADOWMAP_TYPE_VSM"),e}function Rb(o){let e="ENVMAP_TYPE_CUBE";if(o.envMap)switch(o.envMapMode){case xs:case Ss:e="ENVMAP_TYPE_CUBE";break;case bc:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Cb(o){let e="ENVMAP_MODE_REFLECTION";if(o.envMap)switch(o.envMapMode){case Ss:e="ENVMAP_MODE_REFRACTION";break}return e}function wb(o){let e="ENVMAP_BLENDING_NONE";if(o.envMap)switch(o.combine){case i0:e="ENVMAP_BLENDING_MULTIPLY";break;case xS:e="ENVMAP_BLENDING_MIX";break;case SS:e="ENVMAP_BLENDING_ADD";break}return e}function Db(o){const e=o.envMapCubeUVHeight;if(e===null)return null;const i=Math.log2(e)-2,r=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,i),7*16)),texelHeight:r,maxMip:i}}function Ub(o,e,i,r){const l=o.getContext(),u=i.defines;let h=i.vertexShader,d=i.fragmentShader;const m=Ab(i),p=Rb(i),g=Cb(i),v=wb(i),S=Db(i),y=vb(i),A=xb(u),C=l.createProgram();let M,_,z=i.glslVersion?"#version "+i.glslVersion+`
